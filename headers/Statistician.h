...
bool Statistician::equalStatistician(const Statistician& otherStatistcian) const
{
    return (highest == otherStatistcian.highest 
    && lowest == otherStatistcian.lowest 
    && sum == otherStatistcian.sum);
}